...
import com.example.thomas.guitartraining.presentation.presenter.offline.OfflineProgramChoicePresenter;
import com.example.thomas.guitartraining.presentation.view.offline.OfflineSessionChoiceView;
...
public class OfflineProgramChoiceFragment extends Fragment implements OfflineSessionChoiceView {
    ...
    @OnClick(R.id.offline_program_choice_technical)
    public void handleClickOfflineProgramChoiceTechnical() {
        offlineProgramChoicePresenter.launchProgramActivity(2);
    }
}
