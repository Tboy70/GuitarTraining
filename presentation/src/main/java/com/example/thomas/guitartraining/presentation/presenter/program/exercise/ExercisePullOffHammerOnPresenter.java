...
public class ExercisePullOffHammerOnPresenter {
    ...
    @Inject
    public ExercisePullOffHammerOnPresenter(DialogComponent dialogComponent, MaterialDialogComponent materialDialogComponent) {
    ...
    public void launchTimer(Activity activity, long durationLeft) {
        dialogComponent.showTimerDialog(activity, durationLeft, new OnTimerDialogDismiss() {
            ...
            public void onDismiss(long timeCountInMilliSeconds) {
                exercisePullOffHammerOnView.setLeftDuration(timeCountInMilliSeconds);
            }
        });
    }
