...
public class ExerciseSkipStringPresenter {
    ...
    @Inject
    public ExerciseSkipStringPresenter(DialogComponent dialogComponent, MaterialDialogComponent materialDialogComponent) {
    ...
    public void launchTimer(Activity activity, long durationLeft) {
        dialogComponent.showTimerDialog(activity, durationLeft, new OnTimerDialogDismiss() {
            ...
            public void onDismiss(long timeCountInMilliSeconds) {
                exerciseSkipStringView.setLeftDuration(timeCountInMilliSeconds);
            }
        });
    }
