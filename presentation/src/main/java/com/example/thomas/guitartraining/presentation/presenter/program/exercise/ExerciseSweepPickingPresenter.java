...
public class ExerciseSweepPickingPresenter {
    ...
    @Inject
    public ExerciseSweepPickingPresenter(DialogComponent dialogComponent, MaterialDialogComponent materialDialogComponent) {
    ...
    public void launchTimer(Activity activity, long durationLeft) {
        dialogComponent.showTimerDialog(activity, durationLeft, new OnTimerDialogDismiss() {
            ...
            public void onDismiss(long timeCountInMilliSeconds) {
                exerciseSweepPickingView.setLeftDuration(timeCountInMilliSeconds);
            }
        });
    }
