...
public class ExerciseTappingPresenter {
    ...
    @Inject
    public ExerciseTappingPresenter(DialogComponent dialogComponent, MaterialDialogComponent materialDialogComponent) {
    ...
    public void launchTimer(Activity activity, long durationLeft) {
        dialogComponent.showTimerDialog(activity, durationLeft, new OnTimerDialogDismiss() {
            ...
            public void onDismiss(long timeCountInMilliSeconds) {
                exerciseTappingView.setLeftDuration(timeCountInMilliSeconds);
            }
        });
    }
